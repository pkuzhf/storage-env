...
class AGENT_GYM(gym.Env):
    ...
    def _step(self, action):
        ...
        for i in range(self.agent_num):
            ...
            if self.astar.source_hole_map[pos[0]][pos[1]] == -1 and self.agent_city[i] == -1:
            ...
            elif self.astar.source_hole_map[pos[0]][pos[1]] > -1 and self.agent_city[i] != -1:
    ...
    def format_ob(self):
        # formated_ob = np.zeros((self.agent_num, 960), dtype=np.int32)
